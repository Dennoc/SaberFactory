...
namespace SaberFactory.Models.Whacker
{
    ...
    {
        [JsonProperty("trailId")] public int TrailId;
        [JsonProperty("colorType")] public int ColorType;
        [JsonProperty("length")] public int Length;
        [JsonProperty("whiteStep")] public float WhiteStep;
    }

    internal class TrailObject
    {
        [JsonProperty("trailId")] public int TrailId;
        [JsonProperty("isTop")] public bool IsTop;
    }
