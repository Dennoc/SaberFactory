...
namespace SaberFactory.UI.Lib.BSML
{
    ...
    public class CustomListTableDataHandler : TypeHandler
    {
        ...
        public override void HandleType(BSMLParser.ComponentTypeWithData componentType, BSMLParserParams parserParams)
        {
            ...
            tableData.TableView.InvokeMethod<object, TableView>("LazyInit");
            ...
            if (componentType.Data.TryGetValue("id", out var id))
            {
                ...
                parserParams.AddEvent(id + "#PageUp", () => scroller.InvokeMethod<object, ScrollView>("PageUpButtonPressed"));
                parserParams.AddEvent(id + "#PageDown", () => scroller.InvokeMethod<object, ScrollView>("PageDownButtonPressed"));
            }
        }
    }
}